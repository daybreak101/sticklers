...
const breadModifiers = {
  ...
  items: [
    ...
    { id: "spinach_wrap", name: "Spinach Wrap", price: 0, status: "available" },
    { id: "croissant", name: "Croissant", price: 0, status: "available" },
    { id: "croissant_loaf", name: "Croissant Loaf", price: 0, status: "available" },
    { id: "flatbread", name: "Flatbread", price: 0, status: "available" },
  ],
};
...
const sizeModifiers = {
  ...
  type: "single",
  options: [
    { id: "full", name: "Full", price: 0, status: "available" },
    { id: "half", name: "Half", price: 7.05, status: "available", allowedBread: ["french", "wheat"] },
  ],
};
...
const proteinModifiers = {
  ...
  options: [
    ...
    { id: "chicken_salad", name: "Chicken Salad", price: 0, status: "available" },
    ...
    { id: "boiled_eggs", name: "Boiled Eggs", price: 1.99, status: "available" },
  ],
};
...
const extrasModifiers = {
  ...
  options: [
    ...
    { id: "spicy_brown_mustard", name: "Spicy Brown Mustard", price: 0, status: "available" },
    ...
    { id: "italian_seasoning", name: "Italian Seasonings", price: 0, status: "available" },
    ...
    { id: "green_peppers", name: "Green Peppers", price: 0.89, status: "available" },
    { id: "mushrooms", name: "Mushrooms", price: 0.89, status: "available" },
    { id: "ranch", name: "Ranch", price: 0, status: "available" },
    { id: "sriracha_mayo", name: "Sriracha Mayo", price: 0.5, status: "available" },  
  ],
};
...
const saladToppingsModifiers = {
  ...
  options: [
    ...
    { id: "cherry_tomatoes", name: "Cherry Tomatoes", price: 0, status: "available" },
    { id: "carrots", name: "Carrots", price: 0, status: "available" },
    { id: "zucchini", name: "Zucchini", price: 0, status: "available" },
    { id: "green_peppers", name: "Green Peppers", price: 0, status: "available" },
    ...
    { id: "garbanzo_beans", name: "Garbanzo Beans", price: 0, status: "available" },
    ...
    { id: "feta", name: "Feta", price: 0, status: "available" },
    { id: "cottage_cheese", name: "Cottage Cheese", price: 0, status: "available" },
    ...
    { id: "sunflower_seeds", name: "Sunflower Seeds", price: 0, status: "available" },
...
const dressingModifiers = {
  ...
  type: "single",
  options: [
    { id: "ranch_dressing", name: "Ranch Dressing", price: 0, status: "available" },
    { id: "fat_free_ranch", name: "Fat Free Ranch", price: 0, status: "available" },
    { id: "balsamic_vinaigrette", name: "Balsamic Vinaigrette", price: 0, status: "available" },
    { id: "thousand_island_dressing", name: "Thousand Island Dressing", price: 0, status: "available" },
    { id: "caesar_dressing", name: "Caesar Dressing", price: 0, status: "available" },
    { id: "lite_italian_dressing", name: "Lite Italian Dressing", price: 0, status: "available" },
    { id: "honey_mustard", name: "Honey Mustard", price: 0, status: "available" },
    { id: "bleu_cheese_dressing", name: "Bleu Cheese Dressing", price: 0, status: "available" },
    { id: "house_vinaigrette", name: "House Vinaigrette", price: 0, status: "available" },
  ],
};
